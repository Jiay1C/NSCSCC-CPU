...
HD_PWD='C:/Users/Microapple/OneDrive - Rain/NSCSCC/myTest/myTest.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FPGA_green_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FPGA_green_test.tcl
