...
HD_PWD='C:/Users/Microapple/OneDrive - Rain/NSCSCC/myTest/myTest.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FPGA_green_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FPGA_green_test.tcl -notrace
