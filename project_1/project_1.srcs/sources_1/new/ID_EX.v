...
module ID_EX(
    ...
    always @(posedge CLK) begin
        if(RST) {outRDataA,outRDataB,outimm32,outrt,outrd,outshamt,outRegWrite,outHIWrite,outLOWrite,outPCSrc,outMemWrite,outMemtoReg,outExtratoReg,outALUSrc1,outALUSrc2,outALUOP,outRegDst,outBranchType,outExtraData,outPC}<=0;
        else begin
            outRDataA<=inRDataA;
            outRDataB<=inRDataB;
            outimm32<=inimm32;
