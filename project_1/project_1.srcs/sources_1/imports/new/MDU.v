    ...
    begin
            ...
            rsc2_0=rsc2;
                case(mdu_op)
                    ...
                    4'b0100:    begin
                        if(divst) begin mdu_pause   <=    1;tvalid     <=    1;  end
                        else begin      mdu_pause   <=    mdu_pause&~out_tvalid;tvalid     <=    ~tready & tvalid; end
                        tvalidu     <=    0;
                    end
                    4'b1000:    begin
                        if(divst) begin mdu_pause   <=    1;tvalidu     <=    1;  end
                        else begin      mdu_pause   <=    mdu_pause&~out_tvalidu;tvalidu     <=    ~tready & tvalidu; end
                        tvalid      <=    0;
                    end 
                    default:    begin
                        mdu_pause<=0;
