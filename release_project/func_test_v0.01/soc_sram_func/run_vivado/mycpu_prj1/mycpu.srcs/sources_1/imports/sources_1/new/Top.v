...
module mycpu_top (
    ...
    assign debug_wb_pc=MDUPause_EX?0:PC0_MEM_WB;
    assign debug_wb_rf_wen=MDUPause_EX?0:{4{RegWrite_MEM_WB}};
    assign debug_wb_rf_wnum=MDUPause_EX?0:WAddr_MEM_WB;
    assign debug_wb_rf_wdata=MDUPause_EX?0:WData_WB;
    ...
    CU cu(
        ...
        .ERET_ID(ERET_ID||Exception_ID),
        .ERET_EX(ERET_ID_EX||Exception_ID_EX),
        .ERET_MEM(ERET_EX_MEM||Exception_EX_MEM),
        .ERET_WB(ERET_MEM_WB||Exception_MEM_WB),
    ...
    IF_ID if_id(
        .CLK(~CLK_IF_ID),
        .RST(RST||ControlPause_CU||Empty_WB),
        .inPC(PC_IF),
        .inInst(Inst_IF),
    ...
    wire CP0toReg_ID_EX;
    wire MemEN_ID_EX;
    wire Exception_ID_EX;
    wire [1:0]OPType_ID_EX;

    ID_EX id_ex(
        .CLK(~CLK_ID_EX),
        .RST(RST||Empty_WB),
        .WRPause(WRPause_CU),
        .MDUPause(MDUPause_CU),
        .inRDataA(RDataA_ID),
        .inRDataB(RDataB_ID),
        .inimm32(imm32_ID),
        .inrt(rt_ID),
        ...
        .outException(Exception_ID_EX),
        .outOPType(OPType_ID_EX)
    );
    ...
    wire MemEN_EX_MEM;
    wire Exception_EX_MEM;
    wire [1:0]OPType_EX_MEM;
    ...
    EX_MEM ex_mem(
        ...
        .inPC0(PC_ID_EX),
        .inMemEN(MemEN_ID_EX),
        .inException(Exception_ID_EX),
        .inOPType(OPType_ID_EX),
        ...
        .outException(Exception_EX_MEM),
        .outOPType(OPType_EX_MEM)
    );
    ...
    MEM mem(
        ...
        .MemWrite(MemWrite_EX_MEM&&(~Empty_WB)),
        ...
        .MemRData_(MemRData_MEM),
        .outPCSrc(PCSrc_MEM),
        .DMPause(DMPause_MEM),
        .Overflow(Overflow_MEM),
        .MemAddrError(MemAddrError_MEM),
    ...
    wire Exception_MEM_WB;
    wire Overflow_MEM_WB;
    wire MemAddrError_MEM_WB;
    wire [31:0]MemAddr_MEM_WB;
    wire MemWrite_MEM_WB;
    ...
    MEM_WB mem_wb(
        ...
        .inPC0(PC0_EX_MEM),
        .inException(Exception_EX_MEM),
        .inOverflow(Overflow_MEM),
        .inMemAddrError(MemAddrError_MEM),
        .inMemAddr(ALURes_EX_MEM),
        .inMemWrite(MemWrite_EX_MEM),
        ...
        .outPC0(PC0_MEM_WB),
        .outException(Exception_MEM_WB),
        .outOverflow(Overflow_MEM_WB),
        .outMemAddrError(MemAddrError_MEM_WB),
        .outMemAddr(MemAddr_MEM_WB),
        .outMemWrite(MemWrite_MEM_WB)
    );
